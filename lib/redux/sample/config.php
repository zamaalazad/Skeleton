...
$opt_name = '_azadi';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( ' ', 'your-textdomain-here' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
...
$args['footer_text'] = '<p>' . esc_html__( ' ', 'your-textdomain-here' ) . '</p>';
